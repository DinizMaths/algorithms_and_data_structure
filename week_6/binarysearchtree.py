...
class BST:
    ...
    def node(self, current_node, value):
        if current_node.value == value:
            return current_node

        if value < current_node.value:
            return self.node(current_node.left_child, value)

        return self.node(current_node.right_child, value)
    ...
    def get_node(self, value):
        ...
        """
        return self._get_node_recursive(self.root, value)

    def _get_node_recursive(self, current_node, value):
        """
        A helper method to recursively traverse the tree and find the node with the given value.
